...
public static class AssetManifest
{
    ...
    private static Dictionary<string, List<Asset>> Load()
    {
        try
        {
            ...
            if (!File.Exists("AssetManifest.rsv"))
            ...
            using Stream stream = File.OpenRead("assetmanifest.rsv");
            ...
            stopwatch.Stop();
            Logger.Info($"Loaded asset manifest in {stopwatch.ElapsedMilliseconds}ms");
