...
public sealed class EntityLumpViewModel : BspNode, ILumpViewModel
{
    ...
    private void LoadEntityList()
        ...
        {
            innerCache.Clear();
            innerCache.AddOrUpdate(_entityLump.Data.Select(ent => new EntityViewModel(ent) { Parent = this }));
        });
    ...
    public void AddEmptyEntity()
    {
        ...
        Entities.AddOrUpdate(new EntityViewModel(entity) { Parent = this, IsModified = true });
    }
    ...
    public void UpdateViewModelFromModel()
    {
        ...
        foreach (Entity ent in _entityLump.Data)
        {
            ...
            if (!entVm.HasValue)
            {
                var newEntity = new EntityViewModel(ent) { Parent = this };
